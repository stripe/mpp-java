...
/** Well-known Tempo network constants. */
public class TempoDefaults {
    ...
    public static final String MAINNET_USDC     = "0x20C000000000000000000000b9537d11c60E8b50";
    /** PATH_USD contract on Tempo testnet / Moderato (chain 42431). Pass as {@code currency} to {@code charge()}. */
    public static final String TESTNET_PATH_USD = "0x20c0000000000000000000000000000000000000";
}
